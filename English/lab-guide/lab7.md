...
report](../media/lab-07/image17.png)
...
16. Resize the **visual** and move it to the **left box as shown in the
    screenshot**.
...
13. Expand **Sales** table and select **Sales measure**.
    ...
    ![A screenshot of a computer](../media/lab-07/image29.png)
...
chart](../media/lab-07/image31.png)
...
incorrect.](../media/lab-07/image33.png)
...
6. New shortcut dialog opens. Under **External sources**, select
...
18. On the **top right** of the screen, select **Lakehouse -> SQL
    analytics endpoint**.

    ![](../media/lab-07/image51.png)

19. From the top menu, select **Home -> New SQL query**. A new SQL
    query pane opens.
...
23. From the top menu select **Refresh**. Notice now in the Line chart
    there is data for May 2024. Also, notice the Sales amount and Units
    has increased.

    ![A graph on a screen AI-generated content may be
incorrect.](../media/lab-07/image53.png)
