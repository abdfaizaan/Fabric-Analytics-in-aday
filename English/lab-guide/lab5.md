...
1. Let's navigate back to the Fabric workspace, **FAIAD_<inject key="Deployment ID" enableCopy="false"/>**
...
1. From the left panel, click **FAIAD_<inject key="Deployment ID" enableCopy="false"/>**, to be navigated
...
22. With the help of IntelliSense select **variables('varSuccess')**.
    ...
    ![ program](../media/lab-05/image33.png)
